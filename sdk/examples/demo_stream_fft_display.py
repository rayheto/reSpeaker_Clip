#!/usr/bin/env python3
"""Minimal real-device demo: capture + real-time FFT spectrum of RTC audio.
...
def main() -> int:
    ...
    try:
        ...
        # Safety net: ensure cursor is restored even if run() raised
        # before reaching its own finally (e.g. during connect/setup).
        if cursor_hidden:
            sys.stdout.write("\033[?25h")
            sys.stdout.flush()
